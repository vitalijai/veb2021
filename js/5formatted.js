...
var region_list = document.querySelector('#region-list');
var datalist = "";

for (var i = 0; i < mas['areas'].length; i++) {
    var option = document.createElement('option');
    option.id = i;
    option.value = mas['areas'][i]['name'];
    region_list.appendChild(option);
}
region.addEventListener('change', function () {
    var list = document.getElementById('region-list').children;

    for (var i = 0; i < list.length; i++) {
        var data = list[i];
        if (data.getAttribute('value') === region.value) {
            datalist = data.getAttribute("id");
    ...
    var cityoption = city_list.childNodes;
    while(cityoption.length != 0)
    {
        city_list.removeChild(cityoption[0]);
    }
   if(datalist != '')
   {
    for (var i = 0; i < mas['areas'][datalist]['areas'].length; i++) {
        var option = document.createElement('option');
        option.value = mas['areas'][datalist]['areas'][i]['name'];
